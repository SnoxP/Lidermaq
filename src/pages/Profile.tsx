...
import { User, Mail, Save, Shield, LogOut, Camera, MapPin, Calendar, Hash, Clock, Package, DollarSign, Loader2 } from 'lucide-react';
            ...
            <form onSubmit={handleUpdate} className="space-y-6">
              ...
              <div className="pt-6 flex flex-col sm:flex-row gap-4">
                ...
                <button 
                  ...
                  className="px-8 py-4 text-red-600 font-bold hover:bg-red-50 dark:hover:bg-red-500/10 rounded-xl transition-colors flex justify-center items-center gap-2 border border-transparent dark:border-red-500/20"
                >
                  <LogOut size={20} /> Sair
                </button>
              </div>
