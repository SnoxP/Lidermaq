    ...
    <div className="pt-32 pb-20">
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-20">
          <h1 className="text-5xl font-black tracking-tighter mb-6 dark:text-white">NOSSA HISTÓRIA</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-black tracking-tighter dark:text-white">QUALIDADE QUE VEM DE BERÇO</h2>
            ...
            <div className="grid grid-cols-2 gap-6 pt-6">
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-sm dark:text-white">Confiança</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-accent/10 rounded-lg flex items-center justify-center text-accent">
                  <Award size={20} />
                </div>
                <span className="font-bold text-sm dark:text-white">Excelência</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-neutral-bg dark:bg-neutral-800 p-10 rounded-3xl text-center transition-colors duration-300">
            ...
            <h3 className="text-4xl font-black mb-2 dark:text-white">10+</h3>
            <p className="text-primary/60 dark:text-white/60 font-bold uppercase text-xs tracking-widest">Anos de Mercado</p>
          </div>
          <div className="bg-neutral-bg dark:bg-neutral-800 p-10 rounded-3xl text-center transition-colors duration-300">
            <Users className="text-accent mx-auto mb-6" size={40} />
            <h3 className="text-4xl font-black mb-2 dark:text-white">15k+</h3>
            <p className="text-primary/60 dark:text-white/60 font-bold uppercase text-xs tracking-widest">Clientes Satisfeitos</p>
          </div>
          <div className="bg-neutral-bg dark:bg-neutral-800 p-10 rounded-3xl text-center transition-colors duration-300">
            <Award className="text-accent mx-auto mb-6" size={40} />
            <h3 className="text-4xl font-black mb-2 dark:text-white">100%</h3>
            <p className="text-primary/60 dark:text-white/60 font-bold uppercase text-xs tracking-widest">Garantia de Qualidade</p>
          </div>
        </div>
      </div>
    </div>
