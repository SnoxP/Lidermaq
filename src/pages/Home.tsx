        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white leading-tight mb-6 tracking-tighter">
              MÓVEIS QUE DURAM.<br />
              <span className="text-accent">CONFIE NA LIDERMAQ.</span>
            </h1>
            <p className="text-xl text-white/70 mb-10 max-w-xl leading-relaxed">
              Design sofisticado, materiais premium e a garantia de quem entende de móveis há mais de 30 anos. Transforme sua casa com a Lidermaq.
            </p>
            ...
            <div className="mt-16 flex flex-wrap gap-8">
              {['Sofás', 'Mesas', 'Cadeiras', 'Dormitórios'].map((cat) => (
                <Link 
                  key={cat} 
                  to={`/catalogo?cat=${cat}`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-primary/60">Todos os nossos móveis possuem garantia de fábrica e suporte especializado.</p>
              </div>
            </div>
            <div className="flex gap-6">
              <div className="w-16 h-16 bg-neutral-bg rounded-2xl flex items-center justify-center text-accent shrink-0">
            ...
            <div className="flex gap-6">
              ...
              <div>
                ...
                <p className="text-primary/60">Equipe técnica qualificada para realizar a montagem completa em sua residência.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative h-[400px] rounded-3xl overflow-hidden group">
              ...
              <div className="absolute inset-0 bg-black/50 p-10 flex flex-col justify-end">
                ...
                <p className="text-white/70 mb-6 max-w-sm">Suporte especializado para seus móveis Lidermaq, garantindo vida longa ao seu investimento.</p>
      ...
      <section className="py-20 bg-neutral-bg">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-primary/60 max-w-2xl mx-auto">Dicas de decoração, manutenção e as últimas tendências do mercado de móveis.</p>
          </div>
